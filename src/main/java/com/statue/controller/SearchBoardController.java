...
import com.statue.domain.PageMaker;
import com.statue.domain.SearchCriteria;
import com.statue.service.BoardService;
...
//		pageMaker.setTotalCount(service.listCountCriteria(cri));
	...
	public void listtest(@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception{
		logger.info(cri.toString());
